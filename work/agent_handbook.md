...
## (07-12 08:30) 실제 리더보드
- 우리 19위 0.790267(은행). **컷(12위) 0.792827 — 격차 +0.00256**. 16-21위 0.0005폭 밀집(순위방어 가능). top-12는 warm-start천장(+0.0006)의 4배 = 측정경로 없음. 목표 재조정: top-12 저확률 문샷 유지하되 순위방어(클러스터 상단) 현실화.

## (07-12 09:00) 목적함수 전환 — top-12 아니면 무의미(사용자 확정)
순위방어·은행보호·안전한 소폭인상 전부 폐기. 오직 컷(0.79283, 필요 +0.00256=casc+0.0055) 도달. 꼬리확률 최적화 — 고분산 베팅만. warm-start(+0.0006)류 무가치. 문샷/구조적 레버에 GPU 집중.
