...
GO_CASC, GO_SOLO, GO_SAMETEXT = 0.0035, 0.0, -0.002
MEMBER = os.path.join(ROOT, "work", "member_m1wsT3b_q8dir")
...
np.savez(os.path.join(ROOT, "work/gate_m1wsT3b_5k.npz"), rows=rows,
